...
def etc_flashdwnld(com_port,hex_file,baudrate):

     #"""   ------------------------------------------------------------------------------------------- """
     #"""                              Set-up the COM port                                              """
     #"""   ------------------------------------------------------------------------------------------- """
     pp = flash_dwnld.etcFlash(com_port,baudrate) # open port COM10
...
baudrate = int(raw_input('Enter the Baud Rate:'))
hexfile = raw_input('Enter the hex file to be copied to flash memory:')
etc_flashdwnld(comport,hexfile,baudrate)