...
# Generated on Wed Jun 04 11:30:33 2014 by udayakum
...
# stc_1000mb_filtered_result.tcl script.
...
set StcSystem(1) [ stc::perform loadfromxml -filename [ file join [ file dirname [ info script ] ] {stc_1000mb_filtered_result.xml} ] ]
...
proc run {} {
    # Subscribe to results for result query stc_1000mb_filtered_result-0001-rxstreamsummaryresults
    ...
    stc::subscribe -parent [lindex [stc::get system1 -children-Project] 0] \
        ...
        -interval 1 -filenamePrefix "stc_1000mb_filtered_result-0002-txstreamresults"

    # Subscribe to results for result query stc_1000mb_filtered_result-0003-generatorportresults
    stc::subscribe -parent [lindex [stc::get system1 -children-Project] 0] \
        -resultParent " [lindex [stc::get system1 -children-Project] 0] " \
        -configType generator \
        -resultType generatorportresults \
        -filterList "" \
        -viewAttributeList "totalframecount totaloctetcount " \
        -interval 1 -filenamePrefix "stc_1000mb_filtered_result-0003-generatorportresults"

    # Subscribe to results for result query stc_1000mb_filtered_result-0004-analyzerportresults
    stc::subscribe -parent [lindex [stc::get system1 -children-Project] 0] \
        -resultParent " [lindex [stc::get system1 -children-Project] 0] " \
        -configType analyzer \
        ...
        -filterList "" \
        -viewAttributeList "totalframecount totaloctetcount " \
        -interval 1 -filenamePrefix "stc_1000mb_filtered_result-0004-analyzerportresults"
