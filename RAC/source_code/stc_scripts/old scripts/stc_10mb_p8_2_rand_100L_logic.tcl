...
# Generated on Thu Jan 08 13:41:50 2015 by udayakum
...
# stc_10mb_p8_2_rand_100L.tcl script.
...
set StcSystem(1) [ stc::perform loadfromxml -filename [ file join [ file dirname [ info script ] ] {stc_10mb_p8_2_rand_100L.xml} ] ]
...
proc run {} {
    # Subscribe to results for result query stc_10mb_p8_2_rand_100L-0001-generatorportresults
    stc::subscribe -parent [lindex [stc::get system1 -children-Project] 0] \
        ...
        -interval 1 -filenamePrefix "stc_10mb_p8_2_rand_100L-0001-generatorportresults"

    # Subscribe to results for result query stc_10mb_p8_2_rand_100L-0002-analyzerportresults
    stc::subscribe -parent [lindex [stc::get system1 -children-Project] 0] \
        -resultParent " [lindex [stc::get system1 -children-Project] 0] " \
        -configType analyzer \
        ...
        -interval 1 -filenamePrefix "stc_10mb_p8_2_rand_100L-0002-analyzerportresults"

    # Subscribe to results for result query stc_10mb_p8_2_rand_100L-0003-rxstreamsummaryresults
    stc::subscribe -parent [lindex [stc::get system1 -children-Project] 0] \
        -resultParent " [lindex [stc::get system1 -children-Project] 0] " \
        ...
        -interval 1 -filenamePrefix "stc_10mb_p8_2_rand_100L-0003-rxstreamsummaryresults"

    # Subscribe to results for result query stc_10mb_p8_2_rand_100L-0004-txstreamresults
    stc::subscribe -parent [lindex [stc::get system1 -children-Project] 0] \
        -resultParent " [lindex [stc::get system1 -children-Project] 0] " \
        -configType streamblock \
        ...
        -interval 1 -filenamePrefix "stc_10mb_p8_2_rand_100L-0004-txstreamresults"
