...
# Generated on Wed Mar 25 14:37:01 2015 by udayakum
...
# stc_1000mb_p11_1_rand_100L_4v4.tcl script.
...
proc config {portLocations} {
    ...
    set StcSystem(1) [ stc::perform loadfromxml -filename [ file normalize [ file join [ file dirname [ info script ] ] {stc_1000mb_p11_1_rand_100L_4v4.xml} ] ] ]
...
proc run {} {
    # Subscribe to results for result query stc_1000mb_p11_1_rand_100L_4v4-0001-generatorportresults
    stc::subscribe -parent [lindex [stc::get system1 -children-Project] 0] \
        ...
        -interval 1 -filenamePrefix "stc_1000mb_p11_1_rand_100L_4v4-0001-generatorportresults"

    # Subscribe to results for result query stc_1000mb_p11_1_rand_100L_4v4-0002-analyzerportresults
    stc::subscribe -parent [lindex [stc::get system1 -children-Project] 0] \
        -resultParent " [lindex [stc::get system1 -children-Project] 0] " \
        -configType analyzer \
        ...
        -interval 1 -filenamePrefix "stc_1000mb_p11_1_rand_100L_4v4-0002-analyzerportresults"

    # Subscribe to results for result query stc_1000mb_p11_1_rand_100L_4v4-0003-streamthresholdresults
    stc::subscribe -parent [lindex [stc::get system1 -children-Project] 0] \
        -resultParent " [lindex [stc::get system1 -children-Project] 0] " \
        -configType analyzer \
        -resultType streamthresholdresults \
        -filterList "[lindex [stc::get system1.Project(1) -children-CounterResultFilter] 0] [lindex [stc::get system1.Project(1) -children-CounterResultFilter] 1] [lindex [stc::get system1.Project(1) -children-CounterResultFilter] 2] [lindex [stc::get system1.Project(1) -children-CounterResultFilter] 3] [lindex [stc::get system1.Project(1) -children-CounterResultFilter] 8] [lindex [stc::get system1.Project(1) -children-CounterResultFilter] 9] [lindex [stc::get system1.Project(1) -children-CounterResultFilter] 10] [lindex [stc::get system1.Project(1) -children-CounterResultFilter] 12] " \
        -viewAttributeList "customfiltercount1 customfiltercount2 customfiltercount3 customfiltercount4 customfiltercount5 customfiltercount6 customfiltercount7 customfiltercount8 customfiltercount9 customfiltercount10 customfiltercount11 customfiltercount12 customfiltercount13 customfiltercount14 customfiltercount15 " \
        -interval 1 -filenamePrefix "stc_1000mb_p11_1_rand_100L_4v4-0003-streamthresholdresults"

    # Subscribe to results for result query stc_1000mb_p11_1_rand_100L_4v4-0004-rxstreamsummaryresults
    stc::subscribe -parent [lindex [stc::get system1 -children-Project] 0] \
        -resultParent " [lindex [stc::get system1 -children-Project] 0] " \
        ...
        -interval 1 -filenamePrefix "stc_1000mb_p11_1_rand_100L_4v4-0004-rxstreamsummaryresults"

    # Subscribe to results for result query stc_1000mb_p11_1_rand_100L_4v4-0005-txstreamresults
    stc::subscribe -parent [lindex [stc::get system1 -children-Project] 0] \
        -resultParent " [lindex [stc::get system1 -children-Project] 0] " \
        -configType streamblock \
        ...
        -interval 1 -filenamePrefix "stc_1000mb_p11_1_rand_100L_4v4-0005-txstreamresults"
